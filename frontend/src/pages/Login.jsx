    ...
    <div className="max-w-md mx-auto my-16 space-y-8 animate-fade-in">
      <div className="text-center space-y-2">
        ...
        <p className="text-slate-500 dark:text-slate-400 text-sm">
          Sign in to join room watch parties and chat with friends.
        </p>
      </div>
      ...
      <div className="bg-white dark:bg-slate-900/40 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 shadow-2xl backdrop-blur-sm space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="font-bold text-lg font-display text-slate-900 dark:text-white">Sign In</h2>
            <p className="text-xs text-slate-500 dark:text-slate-400">Enter your credentials below.</p>
          </div>
        </div>
        ...
        <div className="text-center pt-1">
          <p className="text-sm text-slate-500 dark:text-slate-400">
            ...
            <Link to="/signup" className="text-indigo-500 dark:text-indigo-400 hover:text-indigo-600 dark:hover:text-indigo-300 font-semibold transition-colors">
              Sign Up
            </Link>
          </p>
        </div>
